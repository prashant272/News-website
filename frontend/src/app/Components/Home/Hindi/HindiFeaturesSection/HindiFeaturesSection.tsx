                    ...
                    <div className={styles.column}>
                        ...
                        {loading ? (
                            ...
                            >
                                <div className={styles.bigImageWrapper}>
                                    <Image
                                        ...
                                        priority
                                    />
                                    <div className={styles.bigBadge}>विशेष</div>
                                </div>
                                <div className={styles.bigContent}>
                                    ...
                                    <div className={styles.bigFooter}>
                                        ...
                                        <span className={styles.readMore}>ज्यादा पढ़ें</span>
                                    </div>
                                </div>
                            </Link>
                        ) : (
                            <div className={styles.noNewsBig}>
                                ...
                                <p>अभी कोई विशेष लेख उपलब्ध नहीं है।</p>
                            </div>
                        )}
                    </div>
...
export default HindiFeaturesSection;
